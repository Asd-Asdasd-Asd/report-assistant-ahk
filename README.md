...
当前项目状态：`v0.5.0-alpha.0` Color Reset V1 production baseline 已冻结，正在准备 internal-alpha packaging/configuration。
...
1. 从 field-validated Color Reset V1 baseline 构建 internal-alpha package
