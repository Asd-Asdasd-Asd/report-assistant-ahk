...
class HotstringConfigTests(unittest.TestCase):
    ...
    def test_schema_path_first_launch_and_utf16_are_centralized(self) -> None:
        ...
        self.assertIn('static SchemaVersion := 1', app_config)
        ...
        self.assertIn('return localAppData "\\" ReportAssistantConfigDefaults.DirectoryName', app_config)
        self.assertIn('throw Error("LOCALAPPDATA is unavailable")', app_config)
        self.assertNotIn("A_LocalAppData", app_config + config)
